...
export function Testimonials() {
    ...
    return (
        <motion.section
            className="relative z-20 flex h-screen w-full flex-col items-center justify-center overflow-clip bg-primary-400 px-12 py-24 font-title text-4xl md:px-24"
            layout>
            <Quote />
